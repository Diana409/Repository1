    ...
    public partial class frmManager : Form
    {
        ...
        private void frmManager_Load(object sender, EventArgs e)
        {
            if (Id > 0)
            {
                ...
                com.CommandText = "Managers_Select";
                com.Parameters.Add(new SqlParameter("@managersId", SqlDbType.Int));
                com.Parameters["@managersId"].Value = Id;
                con.Open();
                ...
                while (rdr.Read())
                {
                    ...
                    dateTimePicker1.Value = (DateTime)(rdr.GetValue(rdr.GetOrdinal("Дата рождения")));
                }
                con.Close();
            }
        }
        ...
        {   
            ...
            if (txtSurname.Text != "Введите фамилию" && txtName.Text != "Введите имя" && txtPatronymic.Text != "Введите отчество")
            {
                try
                {
                    if (Id >= 0)
                    {
                        com.CommandText = "Managers_Update";
                        com.Parameters.Add(new SqlParameter("@managersId", SqlDbType.Int));
                        com.Parameters["@managersId"].Value = Id;
                        ...
                        com.Parameters["@dateOfBirth"].Value = dateTimePicker1.Value;
                        con.Open();
                        com.ExecuteNonQuery();
                        con.Close();
                    ...
                    {
                        com.CommandText = "Managers_Insert";
                        com.Parameters.Add(new SqlParameter("@surname", SqlDbType.NVarChar));
                        com.Parameters["@surname"].Value = txtSurname.Text;
                        com.Parameters.Add(new SqlParameter("@name", SqlDbType.NVarChar));
                        com.Parameters["@name"].Value = txtName.Text;
